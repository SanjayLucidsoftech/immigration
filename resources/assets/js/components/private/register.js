                        ...
                        <form className="form-horizontal" role="form" method="POST" onSubmit= {this.onSubmit.bind(this)}>
                          <fieldset>
                            ...
                            <div className="form-group">
                              <label htmlFor="firstname" className="col-lg-4 control-label">First Name <span className="require">*</span></label>
                              <div className="col-lg-8">
                                <input type="text" className="form-control" id="first_name" ref="first_name" name="first_name" onChange={this.onChange.bind(this)}/>
                              </div>
                            </div>
                            <div className="form-group">
                              <label htmlFor="lastname" className="col-lg-4 control-label">Last Name <span className="require">*</span></label>
                              <div className="col-lg-8">
                          ...
                          <fieldset>
                            ...
                            <div className="form-group">
                              <label htmlFor="confirm-password" className="col-lg-4 control-label">Confirm password <span className="require">*</span></label>
                              <div className="col-lg-8">
                          ...
                          <fieldset>
                            ...
                            <div className="form-group">
                              <label htmlFor="type" className="col-lg-4 control-label">User type <span className="require">*</span></label>
                              <div className="col-lg-8" >
